...
export const useEmailGateway = () => {
  ...
  const { PREPARATION_STARTED_TEMPLATE_ID, SEND_EMAIL_URL } = useRuntimeConfig().public
  return new RealEmailGateway(SEND_EMAIL_URL as string, PREPARATION_STARTED_TEMPLATE_ID as string)
}
