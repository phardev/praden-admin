...
export const dolodentListItem: ProductListItem = {
  ...
  minStockToSell: dolodent.minStockToSell,
  stockManagementMode: dolodent.stockManagementMode,
...
export const ultraLevureListItem: ProductListItem = {
  ...
  minStockToSell: ultraLevure.minStockToSell,
  stockManagementMode: ultraLevure.stockManagementMode,
...
export const anaca3MinceurListItem: ProductListItem = {
  ...
  minStockToSell: anaca3Minceur.minStockToSell,
  stockManagementMode: anaca3Minceur.stockManagementMode,
...
export const chamomillaListItem: ProductListItem = {
  ...
  minStockToSell: chamomilla.minStockToSell,
  stockManagementMode: chamomilla.stockManagementMode,
...
export const calmosineListItem: ProductListItem = {
  ...
  minStockToSell: calmosine.minStockToSell,
  stockManagementMode: calmosine.stockManagementMode,
...
export const hemoclarListItem: ProductListItem = {
  ...
  minStockToSell: hemoclar.minStockToSell,
  stockManagementMode: hemoclar.stockManagementMode,
...
export const productWithoutCategoryListItem: ProductListItem = {
  ...
  minStockToSell: productWithoutCategory.minStockToSell,
  stockManagementMode: productWithoutCategory.stockManagementMode,
...
export const productWithoutLaboratoryListItem: ProductListItem = {
  ...
  minStockToSell: productWithoutLaboratory.minStockToSell,
  stockManagementMode: productWithoutLaboratory.stockManagementMode,
...
export const productWithForbiddenPromotionListItem: ProductListItem = {
  ...
  minStockToSell: productWithForbiddenPromotion.minStockToSell,
  stockManagementMode: productWithForbiddenPromotion.stockManagementMode,
