...
export const ROUTE_PERMISSION_MAP: Record<string, PermissionResource> = {
  ...
  '/loyalty': PermissionResource.CUSTOMERS,
  '/loyalty/multipliers': PermissionResource.CUSTOMERS,
  '/loyalty/multipliers/create': PermissionResource.CUSTOMERS,
  '/loyalty/multipliers/edit': PermissionResource.CUSTOMERS,
