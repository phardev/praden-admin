...
export const ROUTE_PERMISSION_MAP: Record<string, PermissionResource> = {
  ...
  '/vouchers': PermissionResource.VOUCHERS,
  '/vouchers/new': PermissionResource.VOUCHERS,
  ...
  '/carriers': PermissionResource.CARRIERS,
  ...
  '/shop-management/blog-posts': PermissionResource.SHOP_MANAGEMENT,
  ...
  '/shop-management/emergency-pharmacies/edit':
    PermissionResource.SHOP_MANAGEMENT,
  ...
  '/staff/statistics': PermissionResource.OPERATOR_STATISTICS,
...
export const getPermissionKey = (permission: PermissionResource): string => {
  const permissionMap: Record<PermissionResource, string> = {
    ...
    [PermissionResource.VOUCHERS]: 'canAccessVouchers',
    ...
    [PermissionResource.CARRIERS]: 'canAccessCarriers',
    ...
    [PermissionResource.OPERATOR_STATISTICS]: 'canAccessOperatorStatistics',
    ...
    [PermissionResource.ASSISTANCE]: 'canAccessAssistance'
  }
