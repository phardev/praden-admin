...
export interface GetPermissionsVM {
  ...
  canAccessOperatorStatistics: boolean
...
export const getPermissionsVM = (): GetPermissionsVM => {
  ...
  return {
    ...
    canAccessCarriers: userProfileStore.hasPermission(
      PermissionResource.CARRIERS
    ),
    ...
    canAccessShopManagement: userProfileStore.hasPermission(
    ...
    canAccessOperatorStatistics: userProfileStore.hasPermission(
      PermissionResource.OPERATOR_STATISTICS
    ),
    ...
    canAccessAssistance: userProfileStore.hasPermission(
