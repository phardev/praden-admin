            ...
            detail: [
              {
                ...
                customerEmail: orderToPrepare1.contact.email,
            ...
            detail: [
              {
                ...
                customerEmail: orderToPrepare2.contact.email,
            ...
            detail: [
              {
                ...
                customerEmail: orderWithProductWithoutLocation.contact.email,
                createdDate: '21 janv. 2023',
                deliveryPrice: 'Gratuit',
                deliveryAddress: {
                  name: 'Jean Bon',
          ...
          detail: [
            {
              ...
              customerEmail: orderToPrepare3.contact.email,
              createdDate: '5 févr. 2023',
              deliveryPrice: '6,00\u00A0€',
              deliveryAddress: {
                name: "Jeanne D'arc",
          ...
          detail: [
            {
              ...
              customerEmail: orderWithCustomerMessage.contact.email,
              createdDate: '21 janv. 2023',
              deliveryPrice: 'Gratuit',
          ...
          detail: [
            {
              ...
              customerEmail: orderWithPromotionCode.contact.email,
              createdDate: '21 janv. 2023',
              deliveryPrice: 'Gratuit',
              pickingDate: '20/01/2025 12:42',
              promotionCode: {
