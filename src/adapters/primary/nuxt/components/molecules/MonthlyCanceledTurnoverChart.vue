    ...
    svg
      ...
      .on('mouseover', function (event, d) {
        ...
        tooltip
          .style('opacity', 1)
          .html(
            `<strong>${previousYear}</strong><br/>CA Annulé: ${formatCurrency(d.canceledTurnover)}`
          )
          .style('left', left + 'px')
          .style('top', top + 'px')
      })
