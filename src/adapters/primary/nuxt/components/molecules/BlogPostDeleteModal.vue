  ...
  UCard.w-full.max-w-md
    template(#header)
      .flex.items-center.gap-3
        ...
        .space-y-1
          h3.text-lg.font-semibold {{ $t('shopManagement.blogPosts.delete.title') }}
          p.text-sm.text-gray-500 {{ $t('shopManagement.blogPosts.delete.confirm') }}

    .space-y-4
      .p-4.bg-gray-50.rounded-lg(v-if="blogPost")
        .font-medium {{ blogPost.title }}
        .text-sm.text-gray-600.mt-1 /blog/{{ blogPost.slug }}
