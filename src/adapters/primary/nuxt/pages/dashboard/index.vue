  ...
  .dashboard-content(v-else)
    ...
    .grid.grid-cols-1.gap-6.mb-8(class="lg:grid-cols-2")
      UCard
        ...
        template(#default)
          .h-80
            MonthlySalesChart(:data="dashboard.monthlySales" :previous-year-data="dashboard.previousYearMonthlySales")
      UCard
        template(#header)
          h3.text-lg.font-medium {{ $t('dashboard.monthlyTurnover') }}
        template(#default)
          .h-80
            MonthlyTurnoverChart(:data="dashboard.monthlySales" :previous-year-data="dashboard.previousYearMonthlySales")
      UCard()
        template(#header)
      ...
      UCard(v-if="!areProductFiltersApplied")
        ...
        template(#default)
          .h-80
            MonthlyDeliveryPriceChart(:data="dashboard.monthlySales" :previous-year-data="dashboard.previousYearMonthlySales")
      ...
      UCard
        ...
        template(#default)
          .h-80
            MonthlyCanceledTurnoverChart(:data="dashboard.monthlySales" :previous-year-data="dashboard.previousYearMonthlySales")
