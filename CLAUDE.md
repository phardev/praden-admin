...
- Always run tests before committing with parallel execution (`pnpm test-once --parallel`)
...
#### **Testing & Validation**
- `tdd-michael` - Michael AZERHAD-driven TDD
...
Task("Michaël AZERHAD TDD", "...", "tdd-michael")
